...
export const PLANES_REDES = [
  {
    ...
    whatsappText: "Hola Redes y Marketing, quiero cotizar el plan de Identidad Visual",
  },
  {
    id: "first-step",
    icon: "rocket",
    ...
    whatsappText: "Hola Redes y Marketing, quiero cotizar el plan First Step",
  },
  {
    ...
    note: null,
    whatsappText: "Hola Redes y Marketing, quiero cotizar la Asesoría Personalizada",
  },
  {
    id: "plan-inicial",
    icon: "chart",
    ...
    note: null,
    whatsappText: "Hola Redes y Marketing, quiero cotizar el Plan Inicial",
  },
];